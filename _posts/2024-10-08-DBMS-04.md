...
tags: [DBMS, SQL]
description: "SQL 是一种非过程化、面向集合的数据库语言，涵盖数据定义、查询、操纵和控制四大功能，通过 SELECT、DDL 和 DML 等语句实现对数据的全面管理。
其核心在于查询机制（WHERE、GROUP BY、HAVING、JOIN 等）以及视图与约束的使用，用于高效获取数据并保证数据结构与安全性。"
---
